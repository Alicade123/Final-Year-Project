...
//     api.get(`/clerk/farmers/${farmerId}`),
...
//     api.patch('/clerk/notifications/read-all'),

//   // Settings
//   getHubSettings: () =>
//     api.get('/clerk/settings'),

//   updateHubSettings: (settingsData) =>
//     api.put('/clerk/settings', settingsData),
// };
...
//   getProductDetails: (lotId) =>
//     api.get(`/buyer/products/${lotId}`),
...
//     api.post('/buyer/orders', orderData),
...
//   getOrderDetails: (orderId) =>
//     api.get(`/buyer/orders/${orderId}`),

//   cancelOrder: (orderId) =>
//     api.post(`/buyer/orders/${orderId}/cancel`),
